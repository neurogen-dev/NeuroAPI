...
本文档用于解释 NeuroAPI Chat 的部分功能介绍和设计原则。
...
- 注入系统级提示信息、用户输入预处理：详情请看 [https://github.com/neurogen-dev/NeuroAPI/issues/2144](https://github.com/neurogen-dev/NeuroAPI/issues/2144)
